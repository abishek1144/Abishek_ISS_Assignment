...
public class StringsArrays {
	static class StringOperations {
		...
		static void getLength(String selectedString) {
			System.out.println("Length of string: " + selectedString.length());
		...
		static void joinStrings(String firstString, String secondString, CharSequence delimiter) {
			System.out.println("Joined string: " + String.join(" ", firstString, secondString));
		}
		...
		//Method to make all character lowercase
		static void makeStringLowercase(String selectedString) {
			System.out.println("To Lowecase: " +  selectedString.toLowerCase());
		}
		//Method to make all character uppercase
		static void makeStringUppercase(String selectedString) {
			System.out.println("To Uppercase : " + selectedString.toUpperCase());
		}
	}

	public static void main(String[] args) {
		// Implementing all string operation from StringOperations class
